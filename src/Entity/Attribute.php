...
class Attribute
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Consumption", mappedBy="attribute")
     */
    ...
    public function removeConsumption(Consumption $consumption): self
    {
        if ($this->consumptions->contains($consumption)) {
            ...
            if ($consumption->getAttribute() === $this) {
                $consumption->setAttribute(null);
            }
        }
